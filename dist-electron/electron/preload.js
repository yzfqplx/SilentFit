...
electron_1.contextBridge.exposeInMainWorld('api', {
    ...
    clearCollection: (collection) => electron_1.ipcRenderer.invoke('nedb:clearCollection', collection),
    bulkInsert: (collection, docs) => electron_1.ipcRenderer.invoke('nedb:bulkInsert', collection, docs),
});
