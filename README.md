...
**SilentFit** 是一个全面的力量训练追踪与理论学习平台，旨在帮助用户科学地管理力量训练数据，理解力量训练理论，并制定个性化的力量训练计划。它结合了数据可视化、智能推荐和知识图谱等功能，让力量训练过程更透明、更高效。

**核心目标：**
*   **数据驱动的力量训练管理：** 记录并分析用户的训练数据，提供直观的力量训练进度概览。
*   **理论与实践结合：** 通过互动式知识图谱，帮助用户理解力量训练背后的科学原理。
*   **个性化训练计划：** 根据用户数据和力量训练目标，提供智能化的训练建议。
...
*   **跨平台兼容：** 支持桌面应用 (Tauri) 和移动应用 (Capacitor)。
*   **主题切换：** 提供浅色和深色主题模式。
...
访问“力量训练理论”页面，通过交互式知识图谱探索不同的力量训练概念。点击节点查看详细解释，理解它们之间的关联。

#### 3. 查看数据仪表盘

在“仪表盘”页面，您可以概览您的关键绩效指标 (KPIs)、训练趋势图和最大力量记录。这些图表将帮助您直观地了解自己的力量训练进展。
